...
Future<List<dynamic>> fetchData() async {
  String request =
      'https://gateway.marvel.com/v1/public/characters?ts=1&apikey=04a2ff9a844f1270e7de4e88cb739065&hash=d57e55cc7d02e7ac08196eacf07cfaa5'; // URL endpoint untuk mengambil data dari API
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      gambar[
                                          'name'], // Teks yang ingin ditampilkan
                                      style: TextStyle(
